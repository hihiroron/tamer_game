      ...
      : super(
          ...
          animation: SimpleDirectionAnimation(
            idleDown: spriteSheet
                .createAnimation(row: 0, stepTime: 0.4, from: 7, to: 9)
                .asFuture(),
            idleLeft: spriteSheet
                .createAnimation(row: 1, stepTime: 0.4, from: 7, to: 9)
                .asFuture(),
            idleRight: spriteSheet
                .createAnimation(row: 2, stepTime: 0.4, from: 7, to: 9)
                .asFuture(),
            idleUp: spriteSheet
                .createAnimation(row: 3, stepTime: 0.4, from: 7, to: 9)
                .asFuture(),
            runDown: spriteSheet
                .createAnimation(row: 0, stepTime: 0.1, from: 7, to: 9)
                .asFuture(),
            runLeft: spriteSheet
                .createAnimation(row: 1, stepTime: 0.1, from: 7, to: 9)
                .asFuture(),
            runRight: spriteSheet
                .createAnimation(row: 2, stepTime: 0.1, from: 7, to: 9)
                .asFuture(),
            runUp: spriteSheet
                .createAnimation(row: 3, stepTime: 0.1, from: 7, to: 9)
                .asFuture(),
          ),
